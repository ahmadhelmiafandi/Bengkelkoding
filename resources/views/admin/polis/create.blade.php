            ...
            <form action="{{ route('polis.store') }}" method="POST">
                ...
                <div class="flex gap-3">
                    <button type="submit"
                        ...
                        class="flex items-center gap-2 px-6 py-2.5 bg-primary-blue hover:bg-[#1e2d6b] text-white rounded-lg text-sm font-semibold transition shadow-md">
                        <i class="fas fa-save"></i>
                        Simpan
                    </button>

                    <a href="{{ route('polis.index') }}"
                        class="flex items-center gap-2 px-6 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-500 rounded-lg text-sm font-semibold transition border border-slate-200">
                        Batal
                    </a>
                </div>
