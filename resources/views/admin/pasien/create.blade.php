        ...
        <div class="card-body p-8">
            ...
            <form action="{{ route('pasien.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" placeholder="Masukkan email..."
                            class="input w-full border-2 rounded-lg p-2
                                      focus:border-primary focus:outline-none
                ...
                <div class="mb-6">
                    ...
                    <textarea name="alamat" rows="3" placeholder="Masukkan alamat..." class="textarea w-full border-2 rounded-lg p-2
                                     focus:border-primary focus:outline-none
                ...
                <div class="mb-8">
                    ...
                    <input type="password" name="password" placeholder="Minimal 8 karakter..." class="input w-full border-2 rounded-lg p-2
                                  focus:border-primary focus:outline-none
                ...
                <div class="flex gap-3">
                    <button type="submit" class="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl bg-primary 
                    ...
                    <a href="{{ route('pasien.index') }}" class="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl bg-slate-100 
